-- ------------------------------------------------------------
-- Mini TSQL2012 database (for Itzik Ben-Gan Chapter 2)
-- ------------------------------------------------------------
...
(71, 'Customer A', 'USA', 'WA', 'Seattle'),
(79, 'Customer B', 'Germany', 'BE', 'Berlin');
...
(10248, 71, 5, '2006-07-04', '2006-07-18', '2006-07-10', 32.38),
(10249, 71, 5, '2006-07-05', '2006-07-19', '2006-07-12', 11.61),
(10250, 79, 4, '2006-07-08', '2006-07-22', '2006-07-11', 65.83),
(10251, 71, 3, '2006-07-08', '2006-07-22', '2006-07-12', 41.34);
...
(10248, 1, 12, 14.00, 0.0),
(10248, 2, 10, 18.60, 0.1),
(10249, 3, 5,  9.20, 0.0);

-- ------------------------------------------------------------
-- Sales.OrderValues (for val examples)
-- ------------------------------------------------------------
DROP TABLE IF EXISTS Sales.OrderValues;

CREATE TABLE Sales.OrderValues
(
    custid INT,
    orderid INT,
    val MONEY
...
INSERT INTO Sales.OrderValues VALUES
(71, 10248, 100.00),
(71, 10249, 200.00),
(79, 10250, 150.00);
...
(3, 'Nancy', 'Davolio', 'USA', '1992-05-01'),
(4, 'Andrew', 'Fuller', 'USA', '1993-08-14'),
(5, 'Janet', 'Leverling', 'USA', '1994-04-01');
